  ...
  <div class="text-input flex flex-col gap-2">
    <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-2">
      <input
        ...
        v-model="text"
        @input="handleInput"
        class="h-10 bg-zinc-900/50 rounded-lg px-3 text-zinc-100 placeholder-zinc-600 focus:outline-none focus:ring-1 focus:ring-emerald-500/50 transition-colors"
      ...
      <div class="flex items-center gap-2 justify-between sm:justify-start">
        ...
        <div class="flex items-center gap-2">
          <button
            ...
            class="flex-1 sm:flex-none h-10 px-4 text-[10px] bg-emerald-500/20 text-emerald-500 rounded-lg hover:bg-emerald-500/30 transition-colors flex items-center justify-center gap-2 whitespace-nowrap"
            :class="{
          ...
          <button
            ...
            class="flex-1 sm:flex-none h-10 px-4 text-[10px] bg-indigo-500/20 text-indigo-500 rounded-lg hover:bg-indigo-500/30 transition-colors flex items-center justify-center gap-2 whitespace-nowrap group relative"
            :class="{
